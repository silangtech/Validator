...
class Validator
{
    ...
    protected $defaultRegex = [
        'alpha'       => '/^[A-Za-z]+$/', // 只允许字母
        'alphaNum'    => '/^[A-Za-z0-9]+$/', // 只允许字母和数字
        'alphaDash'   => '/^[A-Za-z0-9\-\_]+$/', // 只允许字母、数字和下划线 破折号
        'chs'         => '/^[\x{4e00}-\x{9fa5}]+$/u', // 只允许汉字
        'chsAlpha'    => '/^[\x{4e00}-\x{9fa5}a-zA-Z]+$/u', // 只允许汉字、字母
        'chsAlphaNum' => '/^[\x{4e00}-\x{9fa5}a-zA-Z0-9]+$/u', // 只允许汉字、字母和数字
        'chsDash'     => '/^[\x{4e00}-\x{9fa5}a-zA-Z0-9\_\-]+$/u', // 只允许汉字、字母、数字和下划线_及破折号-
        'phone'       => '/^1[3-9]\d{9}$/', // 手机号码
        'idCard'      => '/(^[1-9]\d{5}(18|19|([23]\d))\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$)|(^[1-9]\d{5}\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{3}$)/', // 身份证
        'zip'         => '/\d{6}/'
    ];
